...
for infile in /home/thiamf/work_agap/DEFI/R1_R2_nuclear_data_trim/*1P.trimmed.fastq.gz; do
base=$(echo ${infile} | sed "s/_1P.trimmed\.fastq\.gz//"); echo ${base}_1P.trimmed.fastq.gz ${base}_2P.trimmed.fastq.gz
