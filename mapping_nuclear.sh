...
for infile in /home/thiamf/work_agap/DEFI/R1_R2_nuclear_data_trim/*1P.trimmed.fastq.gz; do base=$(echo ${infile} | sed "s/_1P.trimmed\.fastq\.gz//"); echo ${base}_1P.trimmed.fastq.gz ${base}_2P.trimmed.fastq.gz
bowtie2 -p 4 -x Dalata_chloro -1 ${base}_1P.trimmed.fastq.gz -2 ${base}_2P.trimmed.fastq.gz | samtools view -bS - > mapping.bam
done

####bowtie2 -x Dalata_chloro -1 /home/thiamf/work_agap/DEFI/R1_R2_nuclear_data_trim/RMM1_S35_L001_2P.trimmed.fastq.gz  -2 /home/thiamf/work_agap/DEFI/R1_R2_nuclear_data_trim/RMM1_S35_L001_2P.trimmed.fastq.gz | samtools view -bS - > test_one_indiv.bam
