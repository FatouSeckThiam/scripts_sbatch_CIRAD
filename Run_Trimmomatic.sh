...
###echo "trimmomatic PE -threads 5 -phred33 ${INPUT1[$SLURM_ARRAY_TASK_ID]} ${INPUT2[$SLURM_ARRAY_TASK_ID]} -baseout ${L1[$SLURM_ARRAY_TASK_ID]} ILLUMINACLIP:NexteraPE-PE.fa:2:30:10 LEADING:3 TRAILING:3 SLIDINGWINDOW:4:15 MINLEN:36"
